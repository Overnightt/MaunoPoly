...
const Game = () => {
    const propriétés = [
        ...
        { id: 12, name: "Avenue de Neuilly", style: { top: "61.5%", left: "0%", width: "13%", height: "8%" } },
        { id: 13, name: "Rue de Paradis", style: { top: "53.5%", left: "0%", width: "13%", height: "8%" } },
        ...
        { id: 18, name: "Place Pigalle", style: { top: "12.7%", left: "0%", width: "13%", height: "8%" } },
        { id: 19, name: "Avenue Matignon", style: { top: "0%", left: "12.8%", width: "8%", height: "13%" } },
        { id: 20, name: "Chance2", style: { top: "0%", left: "21%", width: "8%", height: "13%" } },
        { id: 21, name: "Boulevard Malsherbes", style: { top: "0%", left: "29.3%", width: "8%", height: "13%" } },
        { id: 22, name: "Boulevard Henri-Martin", style: { top: "0%", left: "37.6%", width: "8%", height: "13%" } },
        { id: 23, name: "Gare du Nord", style: { top: "0%", left: "45.7%", width: "8%", height: "13%" } },
        { id: 24, name: "Faubourg Saint-Honoré", style: { top: "0%", left: "54%", width: "8%", height: "13%" } },
        { id: 25, name: "Place de la Bourse", style: { top: "0%", left: "62.3%", width: "8%", height: "13%" } },
        { id: 26, name: "Compagnie de Distribution des Eaux", style: { top: "0%", left: "70.5%", width: "8%", height: "13%" } },
        { id: 27, name: "Rue La Fayette", style: { top: "0%", left: "78.6%", width: "8%", height: "13%" } },
        ...
        { id: 32, name: "Gare Saint-Lazare", style: { top: "45.5%", left: "87%", width: "12.7%", height: "8%" } },
